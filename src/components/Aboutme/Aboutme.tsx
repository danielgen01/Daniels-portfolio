...
const Aboutme = () => {
  return (
    <section className="min-h-[500px] bg-white justify-center items-center">
      <div className="project-banner-content py-10 px-10 flex flex-col gap-4">
        <div className="headline flex">
          <h1 className="text-black text-4xl font-bold">About me</h1>
          <div className="border-b-4 border-black mt-10 ml-5 w-1/4 "></div>
        </div>
        ...
        <div className="buttons w-full flex justify-center gap-10">
          ...
          <button className="font-bold underline-offset-1 underline">
            Download my CV
          </button>
        </div>
